"""
Standalone Chain Example

This example demonstrates how to use the Sifaka chain system without depending on the rest of the Sifaka codebase.
It creates a simple chain with a model and validators, and runs it on a prompt.
"""
...
class KeywordValidator(Validator):
    ...
    def validate(self, output: str) -> ValidationResult:
        ...
        return ValidationResult(
            passed=True,
            message="Keyword validation passed",
            score=1.0
        )
