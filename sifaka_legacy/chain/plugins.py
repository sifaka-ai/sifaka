...
## Usage Examples
```python
# Import the plugin registry and loader for chain components
from sifaka.chain import plugins
...
plugins_list = loader.load_plugins_from_entry_points("sifaka.chain.plugins")
