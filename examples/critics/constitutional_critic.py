...
def create_model_provider():
    ...
    if openai_api_key:
        ...
        return OpenAIProvider(model_name="gpt-4", config=config)
    ...
    if anthropic_api_key:
        ...
        return AnthropicProvider(model_name="claude-3-opus-20240229", config=config)

    # If no API keys are available, use a mock provider
    print("No API keys found. Using MockProvider for demonstration.")
