#!/usr/bin/env python3
"""Self-Refine with Multiple Validators Example.
...
def main():
    ...
    logger.info("Creating PydanticAI Self-Refine with multiple validators example")
    ...
    chain = create_pydantic_chain(
        ...
        critics=[critic],
        max_improvement_iterations=1,  # Only two retries
        always_apply_critics=True,  # Always apply the critic
        analytics_storage=FileStorage(
            "./thoughts/self_refine_example_thoughts.json",
    ...
    # Display results
    print("\n" + "=" * 80)
    print("SELF-REFINE WITH MULTIPLE VALIDATORS EXAMPLE")
    print("=" * 80)
