...
def example_standalone_redis_retriever():
    ...
    documents = [
        ...
        ("ml_intro", "Machine learning is a subset of AI that enables computers to learn without explicit programming."),
        ("dl_overview", "Deep learning uses neural networks with multiple layers to model complex patterns."),
        ("nlp_intro", "Natural language processing enables computers to understand and generate human language."),
        ("python_ai", "Python is the most popular programming language for AI and machine learning projects."),
        ("tensorflow", "TensorFlow is an open-source machine learning framework developed by Google."),
        ("pytorch", "PyTorch is a machine learning library that provides tensor computation and neural networks."),
    ]
