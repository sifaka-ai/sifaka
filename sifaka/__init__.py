...
def __getattr__(name) ->Any:
    ...
    if name in ('Chain', 'ChainResult'):
        ...
        return locals()[name]
    elif name in ('CriticCore', 'create_prompt_critic',
...
__all__: List[Any] = ['Chain', 'ChainResult', 'Generator', 'Improver',
    'ImprovementResult', 'Validator', 'ValidationResult', 'ValidatorConfig',
    'Rule', 'AnthropicProvider', 'OpenAIProvider', 'create_length_rule',
    'CriticCore', 'create_prompt_critic', 'create_reflexion_critic']
