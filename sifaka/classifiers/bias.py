...
class BiasClassifier(TextClassifier):
    ...
    def _classify_with_rules(self, text: str) -> ClassificationResult:
        ...
        bias_indicators = [
            "men are", "women are", "all women", "all men",
            "people from", "those people", "they all",
            "naturally better", "can't understand", "too emotional",
            "all politicians", "rich people", "poor people"
        ]
