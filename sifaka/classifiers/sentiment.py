...
POSITIVE_WORDS = {
    ...
    "best", "better", "positive", "nice", "fine", "glad", "thrilled"
}

NEGATIVE_WORDS = {
    "bad", "terrible", "awful", "horrible", "disgusting", "hate", "dislike",
    "angry", "sad", "disappointed", "frustrated", "annoyed", "upset", "mad",
    "worst", "worse", "negative", "poor", "ugly", "stupid", "boring",
    "wrong", "fail", "failed", "broken", "useless", "worthless", "pathetic"
}
