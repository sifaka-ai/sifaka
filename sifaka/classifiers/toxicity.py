...
TOXIC_WORDS = {
    ...
    "stupid", "idiot", "moron", "dumb", "worthless", "useless", "trash",
    "disgusting", "ugly", "fat", "loser", "failure", "pathetic", "weak",
    "shut up", "go away", "nobody likes", "nobody cares", "waste of space"
}

SEVERE_TOXIC_WORDS = {
    "kill yourself", "kys", "suicide", "die in", "hope you die",
    "cancer", "suffer", "torture", "abuse", "violence upon"
}

THREAT_WORDS = {
    "i will kill", "i'll kill", "gonna kill", "going to hurt",
    "i will hurt", "i'll hurt", "gonna hurt", "beat you up",
    "kick your ass", "destroy you", "ruin your life"
}
