...
@runtime_checkable
class Validator(Protocol[InputType, ResultType]):
    """
    Interface for validators.

    This interface defines the contract for components that validate inputs
    against rules. It ensures that validators can validate inputs and return
    standardized validation results.

    ## Lifecycle

    1. **Initialization**: Set up validation resources
    2. **Validation**: Validate inputs against rules
