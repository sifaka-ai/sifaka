...
# Legacy functions for backward compatibility with error_patterns.py
def create_critic_error_result_dict(
    error: Exception,
    component_name: str,
    log_level: str = "error",
    include_traceback: bool = True,
    ...
    """
    Create a standardized error result dictionary for a critic operation.
...
def create_rule_error_result_dict(
    error: Exception,
    component_name: str,
    log_level: str = "error",
    include_traceback: bool = True,
    ...
    """
    Create a standardized error result dictionary for a rule operation.
