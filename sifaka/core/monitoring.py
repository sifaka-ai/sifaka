    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "critics": {
                ...
                "avg_time_per_call": round(self.critic_time / self.critic_calls, 3) if self.critic_calls > 0 else 0,
            },
            "validators": {
                "calls": self.validator_calls,
                "validators_used": list(set(self.validators_used)),
                "avg_time_per_call": round(self.validator_time / self.validator_calls, 3) if self.validator_calls > 0 else 0,
            },
            "iterations": {
                "completed": self.iterations_completed,
                "max": self.max_iterations,
                "completion_rate": round(self.iterations_completed / self.max_iterations, 2) if self.max_iterations > 0 else 0,
            },
            "results": {
...
class PerformanceMonitor:
    ...
    async def track_validator_call(self, validator_name: str, func: Callable[[], Any]) -> Any:
    ...
    def get_summary_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": sum(1 for m in self.history if m.improvement_achieved) / len(self.history),
        }
