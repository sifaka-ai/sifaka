...
independent assessment attempts and consensus building."""
    ...
    def _get_critic_specific_metadata(self, feedback) -> Dict[str, Any]:
        ...
        self_consistency_metadata = {
            ...
            "consistency_strength": "strong" if feedback.confidence > 0.8 else "moderate" if feedback.confidence > 0.6 else "weak",
            "reliability_assessment": "high" if feedback.confidence >= self.consistency_threshold else "low",
