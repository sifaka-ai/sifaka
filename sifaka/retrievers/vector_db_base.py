...
class VectorDBRetriever(Protocol):
    ...
    @abstractmethod
    def retrieve_for_thought(
        self, 
        thought: Thought, 
        is_pre_generation: bool = True
    ) -> Thought:
    ...
    **kwargs: Any,
    ...
    if provider == "milvus":
        ...
        raise NotImplementedError(
            "Pinecone retriever not yet implemented. "
            "Currently supported providers: milvus"
        )
    
    elif provider == "weaviate":
        # Future implementation
        raise NotImplementedError(
            "Weaviate retriever not yet implemented. "
            "Currently supported providers: milvus"
        )
