...
class RedisRetriever:
    ...
    def add_document(
        ...
        with error_context(
            ...
            # Store document
            self.redis_client.setex(doc_key, ttl or self.cache_ttl, json.dumps(doc_data))
    ...
    def get_document(self, doc_id: str) -> Optional[Dict[str, Any]]:
        ...
        with error_context(
            ...
            if doc_data:
                return json.loads(doc_data)  # type: ignore
            return None
    ...
    def retrieve(self, query: str) -> List[str]:
        ...
        with error_context(
            ...
            if cached_results:
                ...
                return json.loads(cached_results)[: self.max_results]  # type: ignore
