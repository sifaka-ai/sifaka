...
def process_input(provider: 'ModelProviderCore', prompt: str, **kwargs) -> str:
    """
...
def get_generation_service(provider: 'ModelProviderCore'):
    """
...
def get_cache_stats(provider: 'ModelProviderCore') -> Dict[str, Any]:
    """
