...
Core implementation of Sifaka's chain system.
...
class ChainCore(Generic[OutputType], BaseModel):
    ...
    - Implements the Chain interface from sifaka.interfaces.chain
    - Delegates functionality to specialized components
    - Coordinates model providers, rules, critics, and other components
    - Generates and validates text
