...
This module provides centralized state management for the Sifaka chain system.
...
state.update("validators", validators)
state.update("improver", improver)

# Get state
model = state.get("model")
validators = state.get("validators")
improver = state.get("improver")
