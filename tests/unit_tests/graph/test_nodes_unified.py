...
from sifaka.graph.nodes import GenerateNode, ValidateNode, CritiqueNode
...
class TestCritiqueNode:
    ...
    @pytest.mark.asyncio
    async def test_critique_node_basic_execution(
        self, mock_dependencies, sample_thought_with_validation
    ):
    ...
    @pytest.mark.asyncio
    async def test_critique_node_validation_passed_no_critics(
        self, mock_dependencies, sample_thought_with_validation
    ):
    ...
    @pytest.mark.asyncio
    async def test_critique_node_always_apply_critics(
        self, mock_dependencies, sample_thought_with_validation
    ):
    ...
    @pytest.mark.asyncio
    async def test_critique_node_never_apply_critics(
        self, mock_dependencies, sample_thought_with_validation
    ):
    ...
    @pytest.mark.asyncio
    async def test_critique_node_critic_error(
        self, mock_dependencies, sample_thought_with_validation
    ):
        """Test critique when a critic raises an error."""
        # Make critic fail
        mock_dependencies.critics["constitutional"].critique_async.side_effect = Exception(
            "Critic error"
        )
...
class TestNodeIntegration:
    ...
    async def test_full_node_workflow(self):
        ...
        mock_validator.validate_async.return_value = {"passed": False, "details": {}, "score": 0.5}
