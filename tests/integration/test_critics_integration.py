...
@pytest.mark.parametrize("critic_class,critic_kwargs", [
    (ReflexionCritic, {}),
    (ConstitutionalAICritic, {"principles": ["Be helpful", "Be harmless", "Be honest"]}),
    (SelfRefineCritic, {}),
    (CRITICCritic, {}),
    (ChainOfThoughtCritic, {}),
    (StepByStepCritic, {}),
...
def test_critic_integration(critic_class, critic_kwargs, api_key, llm_provider, integration_timeout):
