...
class TestFullWorkflow:
    ...
    def mock_dependencies(self):
        ...
        mock_critic.improve_async.return_value = (
            "Improved text with balanced perspective, specific examples, and proper citations."
        )
    ...
    async def test_conversation_continuity(self, mock_dependencies):
        ...
        thought2 = await engine.continue_thought(
            thought1, "Tell me more about solar energy specifically"
        )
        ...
        thought3 = await engine.continue_thought(
            thought2, "What about the costs of solar installation?"
        )
