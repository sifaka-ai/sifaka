...
class TestPerformanceMonitoring:
    ...
    def test_chain_performance_tracking(self):
        ...
        chain = Chain(
            model=model, prompt="Test prompt for performance monitoring", retriever=retriever
        )
    ...
    def test_performance_with_critics(self):
        ...
        chain = Chain(
            model=model, prompt="Test prompt that will fail validation", retriever=retriever
        )
        chain.validate_with(validator)
