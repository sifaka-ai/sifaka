...
This module contains tests for the reflexion critic components defined in sifaka/critics/reflexion.py,
including ReflexionCritic, ReflexionPromptFactory, and ReflexionCriticConfig.
"""
...
class TestReflexionCriticConfig(unittest.TestCase):
    ...
    def test_valid_config(self):
        ...
        self.assertEqual(config.memory_buffer_size, 10)
    ...
    def test_invalid_memory_buffer_size(self):
        """Test that an invalid memory_buffer_size raises an error."""
        with self.assertRaises(ValueError):
            ReflexionCriticConfig(
                name="test_critic",
                description="Test critic",
    ...
    def test_invalid_reflection_depth(self):
        """Test that an invalid reflection_depth raises an error."""
        with self.assertRaises(ValueError):
            ReflexionCriticConfig(
                name="test_critic",
                description="Test critic",
