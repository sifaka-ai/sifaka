...
def test_basic_persistence() -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert (
            retrieved_thought.validation_results is not None
        ), "Validation results should not be None"
        assert (
...
def test_querying() -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert (
            ai_results.thoughts[0].text is not None
            and "intelligence" in ai_results.thoughts[0].text
        )
