...
class MockTfidfVectorizer:
    ...
    def __init__(self, max_features=3000, stop_words=None, ngram_range=(1, 2)):
        ...
        self.vocabulary_ = {
            "man": 0, "woman": 1, "male": 2, "female": 3, "gender": 4,
            "race": 5, "ethnic": 6, "minority": 7, "white": 8, "black": 9,
            "conservative": 10, "liberal": 11, "right": 12, "left": 13, "political": 14,
            "young": 15, "old": 16, "elderly": 17, "teen": 18, "age": 19,
            "rich": 20, "poor": 21, "wealth": 22, "poverty": 23, "class": 24,
            "christian": 25, "muslim": 26, "jewish": 27, "hindu": 28, "religion": 29,
            "western": 30, "eastern": 31, "traditional": 32, "modern": 33, "culture": 34,
            "educated": 35, "uneducated": 36, "academic": 37, "school": 38, "education": 39,
            "urban": 40, "rural": 41, "city": 42, "country": 43, "region": 44,
            "neutral": 45, "unbiased": 46, "fair": 47, "balanced": 48, "objective": 49,
        }
...
def test_initialization():
    ...
    assert detector.config.labels == [
        "gender", "racial", "political", "age", "socioeconomic", 
        "religious", "cultural", "educational", "geographical", "neutral"
    ]
