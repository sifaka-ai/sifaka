...
class MockTfidfVectorizer:
    ...
    def __init__(self, max_features=2000, stop_words=None, ngram_range=(1, 1)):
        ...
        self.vocabulary_ = {
            "news": 0, "article": 1, "headline": 2, "report": 3, "journalist": 4,
            "fiction": 5, "novel": 6, "story": 7, "character": 8, "plot": 9,
            "academic": 10, "research": 11, "study": 12, "theory": 13, "hypothesis": 14,
            "technical": 15, "manual": 16, "guide": 17, "instruction": 18, "specification": 19,
            "blog": 20, "post": 21, "blogger": 22, "personal": 23, "opinion": 24,
            "social": 25, "media": 26, "tweet": 27, "post": 28, "share": 29,
            "email": 30, "message": 31, "sender": 32, "recipient": 33, "subject": 34,
            "marketing": 35, "promotion": 36, "advertisement": 37, "brand": 38, "product": 39,
            "legal": 40, "contract": 41, "agreement": 42, "law": 43, "clause": 44,
            "creative": 45, "poem": 46, "song": 47, "artistic": 48, "expression": 49,
        }
...
def test_extract_feature_importances(genre_classifier):
    ...
    genre_classifier.vectorizer.get_feature_names_out = MagicMock(side_effect=Exception("Test error"))
    importances = genre_classifier._extract_feature_importances()
    assert importances == {}
